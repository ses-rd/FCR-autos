...
class ComprobantePagosExteriorElectronico(GeneratedsSuper):
    """Elemento Raiz del Comprobante para Pagos al Exterior Electrónico"""
    subclass = None
    superclass = None
...
class IdDoc(GeneratedsSuper):
    ...
    def __init__(self, TipoeCF, eNCF, FechaVencimientoSecuencia, TipoPago=None, FechaLimitePago=None,
...
class Comprador(GeneratedsSuper):
    ...
    def __init__(self, RazonSocialComprador=None, IdentificadorExtranjero=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
                ...
                self.IdentificadorExtranjero is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ReceptorType', fromsubclass_=False,
        ...
        if self.IdentificadorExtranjero is not None:
            ...
            outfile.write(bytes(('<IdentificadorExtranjero>%s</IdentificadorExtranjero>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.IdentificadorExtranjero),
                                           input_name='IdentificadorExtranjero')),
                eol_)).encode()))
...
class OtraMoneda(GeneratedsSuper):
    ...
    def __init__(self, TipoMoneda=None, TipoCambio=None, MontoExentoOtraMoneda=None, MontoTotalOtraMoneda=None):
        self.original_tagname_ = None
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ReceptorType', fromsubclass_=False,
        ...
        if self.TipoMoneda is not None:
            ...
            outfile.write(bytes(('<TipoMoneda>%s</TipoMoneda>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.TipoMoneda), input_name='TipoMoneda')),
                eol_)).encode()))
...
class Item(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, NombreItem, IndicadorBienoServicio, CantidadItem, PrecioUnitarioItem,
                 MontoItem, IndicadorFacturacion, Retencion=None, DescripcionItem=None, UnidadMedida=None, GradosAlcohol=None,
