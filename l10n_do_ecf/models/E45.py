...
class GubernamentalElectronico(GeneratedsSuper):
    """Elemento Raiz del Gubernamental Electrónico"""
    subclass = None
    superclass = None
...
class Totales(GeneratedsSuper):
    ...
    def __init__(self, MontoTotal, MontoGravadoTotal=0.00, MontoGravadoI1=None, MontoGravadoI2=None,
                 ...
                 ImpuestosAdicionales=None, ValorPagar=None):
        self.original_tagname_ = None
...
class DescuentoORecargo(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea=None, TipoAjuste=None, TipoValor=None, MontoDescuentooRecargo=None):
        self.original_tagname_ = None
        self.NumeroLinea = NumeroLinea
