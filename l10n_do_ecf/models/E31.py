...
class FacturaCreditoFiscalElectronica(GeneratedsSuper):
    """Elemento Raiz de la Factura Credito Fiscal Electronica"""
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, FacturaCreditoFiscalElectronica)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if FacturaCreditoFiscalElectronica.subclass:
            return FacturaCreditoFiscalElectronica.subclass(*args_, **kwargs_)
        else:
            return FacturaCreditoFiscalElectronica(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Encabezado':
            obj_ = Encabezado.factory(Version=None, IdDoc=None, Emisor=None, Comprador=None, Totales=None)
            obj_.build(child_)
            self.set_Encabezado(obj_)
        elif nodeName_ == 'DetallesItems':
            obj_ = DetallesItems.factory()
            obj_.build(child_)
            self.set_DetallesItems(obj_)
        elif nodeName_ == 'DescuentosORecargos':
            obj_ = DescuentosORecargos.factory()
            obj_.build(child_)
            self.set_DescuentosORecargos(obj_)
...
class Encabezado(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Encabezado)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Encabezado.subclass:
            return Encabezado.subclass(*args_, **kwargs_)
        else:
            return Encabezado(*args_, **kwargs_)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='Encabezado', fromsubclass_=False,
                       pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Version':
            self.set_Version(child_.text)
        elif nodeName_ == 'IdDoc':
            obj_ = IdDoc.factory(TipoeCF=None, eNCF=None, FechaVencimientoSecuencia=None, TipoIngresos=None,
                                 TipoPago=None)
            obj_.build(child_)
            self.set_IdDoc(obj_)
        elif nodeName_ == 'Emisor':
            obj_ = Emisor.factory(RNCEmisor=None, RazonSocialEmisor=None, DireccionEmisor=None, FechaEmision=None)
            obj_.build(child_)
            self.set_Emisor(obj_)
        elif nodeName_ == 'Comprador':
            obj_ = Comprador.factory(RNCComprador=None, RazonSocialComprador=None)
            obj_.build(child_)
            self.set_Comprador(obj_)
        elif nodeName_ == 'Totales':
            obj_ = Totales.factory(MontoTotal=None)
            obj_.build(child_)
            self.set_Totales(obj_)
        elif nodeName_ == 'OtraMoneda':
            obj_ = OtraMoneda.factory()
            obj_.build(child_)
            self.set_OtraMoneda(obj_)
...
class IdDoc(GeneratedsSuper):
    ...
    def __init__(self, TipoeCF, eNCF, FechaVencimientoSecuencia, TipoIngresos, TipoPago, IndicadorMontoGravado=None,
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, IdDoc)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if IdDoc.subclass:
            return IdDoc.subclass(*args_, **kwargs_)
        else:
            return IdDoc(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TipoeCF':
            self.set_TipoeCF(child_.text)
        if nodeName_ == 'eNCF':
            self.set_eNCF(child_.text)
        if nodeName_ == 'FechaVencimientoSecuencia':
            self.set_FechaVencimientoSecuencia(child_.text)
        elif nodeName_ == 'IndicadorMontoGravado':
            self.set_IndicadorMontoGravado(child_.text)
        elif nodeName_ == 'TipoIngresos':
            self.set_TipoIngresos(child_.text)
        elif nodeName_ == 'TipoPago':
            self.set_TipoPago(child_.text)
        elif nodeName_ == 'FechaLimitePago':
            self.set_FechaLimitePago(child_.text)
        elif nodeName_ == 'TerminoPago':
            self.set_TerminoPago(child_.text)
...
class Emisor(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Emisor)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Emisor.subclass:
            return Emisor.subclass(*args_, **kwargs_)
        else:
            return Emisor(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'RNCEmisor':
            self.set_RNCEmisor(child_.text)
        elif nodeName_ == 'RazonSocialEmisor':
            self.set_RazonSocialEmisor(child_.text)
        elif nodeName_ == 'NombreComercial':
            self.set_NombreComercial(child_.text)
        elif nodeName_ == 'DireccionEmisor':
            self.set_DireccionEmisor(child_.text)
        elif nodeName_ == 'Municipio':
            self.set_Municipio(child_.text)
        elif nodeName_ == 'Provincia':
            self.set_Provincia(child_.text)
        elif nodeName_ == 'TablaTelefonoEmisor':
            obj_ = TablaTelefonoEmisor.factory()
            obj_.build(child_)
            self.set_TablaTelefonoEmisor(obj_)
        elif nodeName_ == 'CorreoEmisor':
            self.set_CorreoEmisor(child_.text)
        elif nodeName_ == 'WebSite':
            self.set_WebSite(child_.text)
        elif nodeName_ == 'InformacionAdicionalEmisor':
            self.set_InformacionAdicionalEmisor(child_.text)
        elif nodeName_ == 'FechaEmision':
            self.set_FechaEmision(child_.text)
...
class TablaTelefonoEmisor(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TablaTelefonoEmisor)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TablaTelefonoEmisor.subclass:
            return TablaTelefonoEmisor.subclass(*args_, **kwargs_)
        else:
            return TablaTelefonoEmisor(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TelefonoEmisor':
            self.add_TelefonoEmisor(child_.text)
...
class Comprador(GeneratedsSuper):
    ...
    def __init__(self, RNCComprador, RazonSocialComprador, ContactoComprador=None, CorreoComprador=None,
                 ...
                 FechaOrdenCompra=None, NumeroOrdenCompra=None, CodigoInternoComprador=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Comprador)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Comprador.subclass:
            return Comprador.subclass(*args_, **kwargs_)
        else:
            return Comprador(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'RNCComprador':
            self.set_RNCComprador(child_.text)
        elif nodeName_ == 'RazonSocialComprador':
            self.set_RazonSocialComprador(child_.text)
        elif nodeName_ == 'CorreoComprador':
            self.set_CorreoComprador(child_.text)
        elif nodeName_ == 'DireccionComprador':
            self.set_DireccionComprador(child_.text)
        elif nodeName_ == 'MunicipioComprador':
            self.set_MunicipioComprador(child_.text)
        elif nodeName_ == 'ProvinciaComprador':
            self.set_ProvinciaComprador(child_.text)
...
class Totales(GeneratedsSuper):
    ...
    def __init__(self, MontoTotal, MontoGravadoTotal=0.00, MontoGravadoI1=0.00, MontoGravadoI2=0.00,
                 ...
                 ImpuestosAdicionales=None, TotalITBISRetenido=0.00, TotalISRRetencion=0.00):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Totales)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Totales.subclass:
            return Totales.subclass(*args_, **kwargs_)
        else:
            return Totales(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'MontoGravadoTotal':
            self.set_MontoGravadoTotal(child_.text)
        elif nodeName_ == 'MontoGravadoI1':
            self.set_MontoGravadoI1(child_.text)
        elif nodeName_ == 'MontoGravadoI2':
            self.set_MontoGravadoI2(child_.text)
        elif nodeName_ == 'MontoGravadoI3':
            self.set_MontoGravadoI3(child_.text)
        elif nodeName_ == 'MontoExento':
            self.set_MontoExento(child_.text)
        elif nodeName_ == 'ITBIS1':
            self.set_ITBIS1(child_.text)
        elif nodeName_ == 'ITBIS2':
            self.set_ITBIS2(child_.text)
        elif nodeName_ == 'ITBIS3':
            self.set_ITBIS3(child_.text)
        elif nodeName_ == 'TotalITBIS':
            self.set_TotalITBIS(child_.text)
        elif nodeName_ == 'TotalITBIS1':
            self.set_TotalITBIS1(child_.text)
        elif nodeName_ == 'TotalITBIS2':
            self.set_TotalITBIS2(child_.text)
        elif nodeName_ == 'TotalITBIS3':
            self.set_TotalITBIS3(child_.text)
        elif nodeName_ == 'MontoImpuestoAdicional':
            self.set_MontoImpuestoAdicional(child_.text)
        elif nodeName_ == 'MontoTotal':
            self.set_MontoTotal(child_.text)
        elif nodeName_ == 'TotalITBISRetenido':
            self.set_TotalITBISRetenido(child_.text)
        elif nodeName_ == 'TotalISRRetencion':
            self.set_TotalISRRetencion(child_.text)
...
class OtraMoneda(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, OtraMoneda)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if OtraMoneda.subclass:
            return OtraMoneda.subclass(*args_, **kwargs_)
        else:
            return OtraMoneda(*args_, **kwargs_)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ReceptorType', fromsubclass_=False,
        ...
        if self.MontoImpuestoAdicionalOtraMoneda is not None:
            ...
            outfile.write(bytes(('<MontoImpuestoAdicionalOtraMoneda>%s</MontoImpuestoAdicionalOtraMoneda>%s' % (
                self.gds_format_float(self.MontoImpuestoAdicionalOtraMoneda, input_name='Monto del Impuesto Adicional en Otra Moneda'), eol_)).encode()))
        if self.ImpuestosAdicionalesOtraMoneda is not None:
            self.ImpuestosAdicionalesOtraMoneda.export(outfile, level, namespace_, name_='ImpuestosAdicionalesOtraMoneda',
                                                       pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TipoMoneda':
            self.set_TipoMoneda(child_.text)
        elif nodeName_ == 'TipoCambio':
            self.set_TipoCambio(child_.text)
...
class ImpuestosAdicionales(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ImpuestosAdicionales)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ImpuestosAdicionales.subclass:
            return ImpuestosAdicionales.subclass(*args_, **kwargs_)
        else:
            return ImpuestosAdicionales(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ImpuestoAdicional':
            obj_ = ImpuestoAdicional.factory(None)
            obj_.build(child_)
...
class ImpuestoAdicional(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ImpuestoAdicional)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ImpuestoAdicional.subclass:
            return ImpuestoAdicional.subclass(*args_, **kwargs_)
        else:
            return ImpuestoAdicional(*args_, **kwargs_)
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='EmisorType', fromsubclass_=False,
        ...
        if self.MontoImpuestoSelectivoConsumoAdvalorem is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<MontoImpuestoSelectivoConsumoAdvalorem>%s</MontoImpuestoSelectivoConsumoAdvalorem>%s' % (
                self.gds_format_float(self.MontoImpuestoSelectivoConsumoAdvalorem, input_name='MontoImpuestoSelectivoConsumoAdvalorem'), eol_)).encode()))
        if self.OtrosImpuestosAdicionales is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<OtrosImpuestosAdicionales>%s</OtrosImpuestosAdicionales>%s' % (
                self.gds_format_float(self.OtrosImpuestosAdicionales, input_name='OtrosImpuestosAdicionales'), eol_)).encode()))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TipoImpuesto':
            self.set_TipoImpuesto(child_.text)
...
class DetallesItems(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            ...
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DetallesItems.subclass:
            return DetallesItems.subclass(*args_, **kwargs_)
        else:
            return DetallesItems(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Item':
            obj_ = Item.factory(NumeroLinea=None, NombreItem=None, IndicadorBienoServicio=None,
                                CantidadItem=None, PrecioUnitarioItem=None, MontoItem=None, IndicadorFacturacion=None)
            obj_.build(child_)
            self.add_Item(obj_)
...
class Item(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, NombreItem, IndicadorBienoServicio, CantidadItem, PrecioUnitarioItem,
                 ...
                 TablaSubDescuento=None, RecargoMonto=None, TablaSubRecargo=None):
        self.original_tagname_ = None
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'NumeroLinea':
            self.set_NumeroLinea(child_.text)
        elif nodeName_ == 'IndicadorFacturacion':
            self.set_IndicadorFacturacion(child_.text)
        elif nodeName_ == 'NombreItem':
            self.set_NombreItem(child_.text)
        elif nodeName_ == 'IndicadorBienoServicio':
            self.set_IndicadorBienoServicio(child_.text)
        elif nodeName_ == 'DescripcionItem':
            self.set_DescripcionItem(child_.text)
        elif nodeName_ == 'CantidadItem':
            self.set_CantidadItem(child_.text)
        elif nodeName_ == 'UnidadMedida':
            self.set_UnidadMedida(child_.text)
        elif nodeName_ == 'PrecioUnitarioItem':
            self.set_PrecioUnitarioItem(child_.text)
        elif nodeName_ == 'DescuentoMonto':
            self.set_DescuentoMonto(child_.text)
        elif nodeName_ == 'TablaSubDescuento':
            obj_ = TablaSubDescuento.factory()
            obj_.build(child_)
            self.set_TablaSubDescuento(obj_)
        elif nodeName_ == 'MontoItem':
            self.set_MontoItem(child_.text)
        elif nodeName_ == 'TablaCodigosItem':
            obj_ = TablaCodigosItem.factory()
            obj_.build(child_)
            self.set_TablaCodigosItem(obj_)
        elif nodeName_ == 'TablaImpuestoAdicional':
            obj_ = ImpuestosAdicionales.factory()
            obj_.build(child_)
            self.set_TablaImpuestoAdicional(obj_)
...
class TablaCodigosItem(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TablaCodigosItem)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TablaCodigosItem.subclass:
            return TablaCodigosItem.subclass(*args_, **kwargs_)
        else:
            return TablaCodigosItem(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CodigosItem':
            obj_ = CodigosItem.factory()
            obj_.build(child_)
            self.add_CodigosItem(obj_)
...
class CodigosItem(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CodigosItem)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CodigosItem.subclass:
            return CodigosItem.subclass(*args_, **kwargs_)
        else:
            return CodigosItem(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TipoCodigo':
            self.set_TipoCodigo(child_.text)
        elif nodeName_ == 'CodigoItem':
            self.set_CodigoItem(child_.text)
...
class TablaSubcantidad(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
                self.SubcantidadItem is not None
        ):
            return True
        else:
            return False
...
class TablaSubDescuento(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TablaSubDescuento)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TablaSubDescuento.subclass:
            return TablaSubDescuento.subclass(*args_, **kwargs_)
        else:
            return TablaSubDescuento(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'SubDescuento':
            obj_ = SubDescuento.factory(TipoSubDescuento=None)
            obj_.build(child_)
            self.add_SubDescuento(obj_)
...
class SubDescuento(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SubDescuento)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SubDescuento.subclass:
            return SubDescuento.subclass(*args_, **kwargs_)
        else:
            return SubDescuento(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TipoSubDescuento':
            self.set_TipoSubDescuento(child_.text)
        elif nodeName_ == 'SubDescuentoPorcentaje':
            self.set_SubDescuentoPorcentaje(child_.text)
        elif nodeName_ == 'MontoSubDescuento':
            self.set_MontoSubDescuento(child_.text)
...
class DescuentosORecargos(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DescuentoORecargo)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DescuentosORecargos.subclass:
            return DescuentosORecargos.subclass(*args_, **kwargs_)
        else:
            return DescuentosORecargos(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'DescuentoORecargo':
            obj_ = DescuentoORecargo.factory()
            obj_.build(child_)
            self.add_DescuentoItem(obj_)
...
class DescuentoORecargo(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            ...
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DescuentoORecargo.subclass:
            return DescuentoORecargo.subclass(*args_, **kwargs_)
        else:
            return DescuentoORecargo(*args_, **kwargs_)
    ...
    def get_DescripcionDescuentooRecargo(self):
        return self.DescripcionDescuentooRecargo

    def set_DescripcionDescuentooRecargo(self, DescripcionDescuentooRecargo):
        self.DescripcionDescuentooRecargo = DescripcionDescuentooRecargo

    def get_ValorDescuentooRecargo(self):
        return self.ValorDescuentooRecargo

    def set_ValorDescuentooRecargo(self, ValorDescuentooRecargo):
        self.ValorDescuentooRecargo = ValorDescuentooRecargo

    def get_IndicadorFacturacionDescuentooRecargo(self):
        return self.IndicadorFacturacionDescuentooRecargo

    def set_IndicadorFacturacionDescuentooRecargo(self, IndicadorFacturacionDescuentooRecargo):
        self.IndicadorFacturacionDescuentooRecargo = IndicadorFacturacionDescuentooRecargo
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'NumeroLinea':
            self.set_NumeroLinea(child_.text)
        elif nodeName_ == 'TipoAjuste':
            self.set_TipoAjuste(child_.text)
        elif nodeName_ == 'DescripcionDescuentooRecargo':
            self.set_DescripcionDescuentooRecargo(child_.text)
        elif nodeName_ == 'TipoValor':
            self.set_TipoValor(child_.text)
        elif nodeName_ == 'ValorDescuentooRecargo':
            self.set_ValorDescuentooRecargo(child_.text)
        elif nodeName_ == 'MontoDescuentooRecargo':
            self.set_MontoDescuentooRecargo(child_.text)
        elif nodeName_ == 'IndicadorFacturacionDescuentooRecargo':
            self.set_IndicadorFacturacionDescuentooRecargo(child_.text)
...
def parseString(inString, silence=False):
    ...
    rootClass = FacturaCreditoFiscalElectronica
    rootObj = rootClass.factory(Encabezado=None)
