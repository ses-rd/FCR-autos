...
class ComprobanteExportacionesElectronico(GeneratedsSuper):
    """Elemento Raiz del Comprobante de Exportaciones Electrónico"""
    subclass = None
    superclass = None
...
class IdDoc(GeneratedsSuper):
    ...
    def __init__(self, TipoeCF, eNCF, FechaVencimientoSecuencia, TipoIngresos, TipoPago, FechaLimitePago=None,
...
class Comprador(GeneratedsSuper):
    ...
    def __init__(self, RazonSocialComprador, RNCComprador=None, IdentificadorExtranjero=None, ContactoComprador=None, CorreoComprador=None,
                 DireccionComprador=None, MunicipioComprador=None, ProvinciaComprador=None, PaisComprador=None,
                 FechaEntrega=None, ContactoEntrega=None, DireccionEntrega=None, FechaOrdenCompra=None,
                 NumeroOrdenCompra=None, TelefonoAdicional=None, CodigoInternoComprador=None):
        self.original_tagname_ = None
    ...
    def get_PaisComprador(self):
        return self.PaisComprador

    def set_PaisComprador(self, PaisComprador):
        self.PaisComprador = PaisComprador
    ...
    def get_ContactoEntrega(self):
        return self.ContactoEntrega

    def set_ContactoEntrega(self, ContactoEntrega):
        self.ContactoEntrega = ContactoEntrega

    def get_DireccionEntrega(self):
        return self.DireccionEntrega

    def set_DireccionEntrega(self, DireccionEntrega):
        self.DireccionEntrega = DireccionEntrega

    def get_TelefonoAdicional(self):
        return self.TelefonoAdicional

    def set_TelefonoAdicional(self, TelefonoAdicional):
        self.TelefonoAdicional = TelefonoAdicional
    ...
    def hasContent_(self):
        if (
                ...
                self.ContactoEntrega is not None or
                self.DireccionEntrega is not None or
                self.TelefonoAdicional is not None or
                self.CodigoInternoComprador is not None or
                self.PaisComprador is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ReceptorType', fromsubclass_=False,
        ...
        if self.ProvinciaComprador is not None:
            ...
            outfile.write(bytes(('<ProvinciaComprador>%s</ProvinciaComprador>%s' % (
                ...
                eol_)).encode()))
        if self.PaisComprador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<PaisComprador>%s</PaisComprador>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.PaisComprador), input_name='Pais Comprador')),
                eol_)).encode()))
        if self.FechaEntrega is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<FechaEntrega>%s</FechaEntrega>%s' % (
                self.gds_format_date(self.FechaEntrega, input_name='Fecha Entrega'), eol_)).encode()))
        if self.ContactoEntrega is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<ContactoEntrega>%s</ContactoEntrega>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.ContactoEntrega), input_name='Contacto Entrega')),
                eol_)).encode()))
        if self.DireccionEntrega is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<DireccionEntrega>%s</DireccionEntrega>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.DireccionEntrega), input_name='Direccion Entrega')),
                eol_)).encode()))
        if self.TelefonoAdicional is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<TelefonoAdicional>%s</TelefonoAdicional>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.TelefonoAdicional), input_name='Telefono Adicional')),
                eol_)).encode()))
...
class Totales(GeneratedsSuper):
    ...
    def __init__(self, MontoTotal, MontoGravadoTotal=0.00, MontoGravadoI3=None, ITBIS3=None, TotalITBIS=0.00,
                 TotalITBIS3=0.00, MontoImpuestoAdicional=None, ImpuestosAdicionales=None):
        self.original_tagname_ = None
...
class OtraMoneda(GeneratedsSuper):
    ...
    def __init__(self, TipoMoneda=None, TipoCambio=None, MontoTotalOtraMoneda=None,
                 MontoGravadoTotalOtraMoneda=0.00, MontoGravado3OtraMoneda=0.00, TotalITBISOtraMoneda=0.00,
                 TotalITBIS3OtraMoneda=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
                ...
                self.MontoTotalOtraMoneda is not None or
                ...
                self.TotalITBIS3OtraMoneda is not None
        ):
            return True
        else:
            return False
...
class Item(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, NombreItem, IndicadorBienoServicio, CantidadItem, PrecioUnitarioItem,
                 ...
                 PrecioUnitarioReferencia=None, TablaImpuestoAdicional=None, DescuentoMonto=None, TablaSubDescuento=None,
                 RecargoMonto=None, TablaSubRecargo=None):
        self.original_tagname_ = None
