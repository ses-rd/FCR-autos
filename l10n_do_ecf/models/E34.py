...
class NotaCreditoElectronica(GeneratedsSuper):
    """Elemento Raiz de la Nota de Crédito Electrónica"""
    subclass = None
    superclass = None

    def __init__(self, Encabezado, DetallesItems=None, DescuentosORecargos=None, InformacionReferencia=None,
                 FechaHoraFirma=None):
    ...
    def hasContent_(self):
        if (
                ...
                self.InformacionReferencia is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ECF', fromsubclass_=False,
        ...
        if self.InformacionReferencia is not None:
            self.InformacionReferencia.export(outfile, level, namespace_, name_='InformacionReferencia',
                                              pretty_print=pretty_print)
...
class Encabezado(GeneratedsSuper):
    ...
    def __init__(self, Version, IdDoc, Emisor, Totales, Comprador=None, OtraMoneda=None):
        self.original_tagname_ = None
...
class IdDoc(GeneratedsSuper):
    ...
    def __init__(self, TipoeCF, eNCF, TipoIngresos, TipoPago, IndicadorNotaCredito, IndicadorMontoGravado=None,
                 FechaLimitePago=None, IndicadorEnvioDiferido=None):
        self.original_tagname_ = None
    ...
    def get_IndicadorNotaCredito(self):
        return self.IndicadorNotaCredito

    def set_IndicadorNotaCredito(self, IndicadorNotaCredito):
        self.IndicadorNotaCredito = IndicadorNotaCredito
    ...
    def get_IndicadorEnvioDiferido(self):
        return self.IndicadorEnvioDiferido

    def set_IndicadorEnvioDiferido(self, IndicadorEnvioDiferido):
        self.IndicadorEnvioDiferido = IndicadorEnvioDiferido
    ...
    def hasContent_(self):
        if (
                ...
                self.IndicadorNotaCredito is not None or
                self.FechaLimitePago is not None or
                self.IndicadorEnvioDiferido is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='EmisorType', fromsubclass_=False,
        ...
        if self.eNCF is not None:
            ...
            outfile.write(bytes(('<eNCF>%s</eNCF>%s' % (
                ...
                eol_)).encode()))
        if self.IndicadorNotaCredito is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<IndicadorNotaCredito>%s</IndicadorNotaCredito>%s' % (
                self.gds_encode(
                    self.gds_format_integer(self.IndicadorNotaCredito, input_name='IndicadorNotaCredito')),
                eol_)).encode()))
        if self.IndicadorEnvioDiferido is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<IndicadorEnvioDiferido>%s</IndicadorEnvioDiferido>%s' % (
                self.gds_encode(
                    self.gds_format_integer(self.IndicadorEnvioDiferido, input_name='IndicadorEnvioDiferido')),
                eol_)).encode()))
...
class Comprador(GeneratedsSuper):
    ...
    def __init__(self, RazonSocialComprador=None, RNCComprador=None, IdentificadorExtranjero=None,
                 ContactoComprador=None, CorreoComprador=None, DireccionComprador=None, MunicipioComprador=None,
                 ProvinciaComprador=None, FechaEntrega=None, FechaOrdenCompra=None, NumeroOrdenCompra=None,
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ReceptorType', fromsubclass_=False,
        ...
        if self.IdentificadorExtranjero is not None:
            ...
            outfile.write(bytes(('<IdentificadorExtranjero>%s</IdentificadorExtranjero>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.IdentificadorExtranjero), input_name='Identificador Extranjero')),
                eol_)).encode()))
...
class Item(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, NombreItem, IndicadorBienoServicio, CantidadItem, PrecioUnitarioItem,
                 MontoItem, IndicadorFacturacion, Retencion=None, DescripcionItem=None, UnidadMedida=None, TablaCodigosItem=None,
                 DescuentoMonto=None, TablaSubDescuento=None, TablaImpuestoAdicional=None):
        self.original_tagname_ = None
...
class InformacionReferencia(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, NCFModificado, FechaNCFModificado, CodigoModificacion, RNCOtroContribuyente=None,
                 RazonModificacion=None):
        self.original_tagname_ = None
    ...
    def get_NCFModificado(self):
        return self.NCFModificado

    def set_NCFModificado(self, NCFModificado):
        self.NCFModificado = NCFModificado

    def get_FechaNCFModificado(self):
        return self.FechaNCFModificado

    def set_FechaNCFModificado(self, FechaNCFModificado):
        self.FechaNCFModificado = FechaNCFModificado

    def get_CodigoModificacion(self):
        return self.CodigoModificacion

    def set_CodigoModificacion(self, CodigoModificacion):
        self.CodigoModificacion = CodigoModificacion

    def get_RNCOtroContribuyente(self):
        return self.RNCOtroContribuyente

    def set_RNCOtroContribuyente(self, RNCOtroContribuyente):
        self.RNCOtroContribuyente = RNCOtroContribuyente

    def get_RazonModificacion(self):
        return self.RazonModificacion

    def set_RazonModificacion(self, RazonModificacion):
        self.RazonModificacion = RazonModificacion

    def hasContent_(self):
        if (
                self.NCFModificado is not None or
                self.FechaNCFModificado is not None or
                self.CodigoModificacion is not None or
                self.RNCOtroContribuyente is not None or
                self.RazonModificacion is not None
        ):
            return True
        else:
            return False
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='LineaItemType', fromsubclass_=False,
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.NCFModificado is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<NCFModificado>%s</NCFModificado>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.NCFModificado), input_name='NCFModificado')),
                eol_)).encode()))
        if self.RNCOtroContribuyente is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<RNCOtroContribuyente>%s</RNCOtroContribuyente>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.RNCOtroContribuyente), input_name='RNCOtroContribuyente')),
                eol_)).encode()))
        if self.FechaNCFModificado is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<FechaNCFModificado>%s</FechaNCFModificado>%s' % (
                self.gds_format_date(self.FechaNCFModificado, input_name='FechaNCFModificado'), eol_)).encode()))
        if self.CodigoModificacion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<CodigoModificacion>%s</CodigoModificacion>%s' % (
                self.gds_encode(
                    self.gds_format_integer(self.CodigoModificacion, input_name='CodigoModificacion')),
                eol_)).encode()))
        if self.RazonModificacion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<RazonModificacion>%s</RazonModificacion>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.RazonModificacion), input_name='RazonModificacion')),
                eol_)).encode()))
