        ...
        for record in self:
            ...
            if tax_totals.get('has_tax_groups', False):
                ...
                for subtotal in subtotals:
                    ...
                    tax_group_taxable = self.env['account.tax.group'].search(
                        [('l10n_do_billing_indicator', 'in', ['taxable_itbis', 'taxable_isr'])])
                    ...
                    for tax_group in list(filter(lambda m: m['id'] in tax_group_taxable.ids, tax_groups)):
                        ...
                        tax = self.env['account.tax'].search(
                            [('id', 'in', involved_tax_ids), ('tax_group_id', '=', tax_group_id)], limit=1)
